...
export declare function createGetKcContext<
    KcContextExtension extends {
        pageId: string;
    } = never
>(params?: {
    ...
    getKcContext: <PageId extends ExtendKcContext<KcContextExtension>["pageId"] | undefined = undefined>(
        params?:
            | {
                  ...
                  storyPartialKcContext?:
                      | DeepPartial<
                            Extract<
                                ExtendKcContext<KcContextExtension>,
                                {
                                    pageId: PageId;
                                }
                            >
